...
// ./auth.constant.js 에서 MIN_PASSWORD_LENGTH 값을 그대로 가지고온다
import { MIN_RESUME_LENGTH } from './resume.constant.js';
//  ./resume.constant.js 에서 MIN_RESUME_LENGTH 값을 그대로 가지고온다
...
// MESSAGES 객체에 안에 또 다른 객체를 저장함으로써 이중 객체 형태를 가지고 있고 다른 파일에서 사용가능하도록 설정되어있다